...
function setup = generateSetupOlfatiSaber(configFile, param, setVelocity, pos, vel, varargin)
switch nargin
    case 3
...
for i = 1:length(Agents)
    Agents{i} = OlfatiSaberAgent(Network.getId(), param, pos(:,i), vel(:,i), configFile);
end
setup.Agents = [Agents{:}];
