...
switch(index)
    ...
    case (1)
        cfg.lambda      = 0.05;     % control weight
        cfg.lambda_o    = 1.5;      % obstacle weight
        cfg.lambda_a    = 0.1;      % attractive force multiplier
    ...
    case (3)
        ...
        cfg.c1b = 0.6;              % P gain beta flocking
        cfg.c2b = 0;                % D gain beta flocking
        cfg.c1g = 0.4;              % P gain gamma flocking
        cfg.c2g = sqrt(cfg.c1g);    % D gain gamma flocking
